...
<div class="project-grid" id="industry-projects">
  <div class="project-card">
    ...
    <p>融合用户画像、多尺度兴趣和行为序列，完成从大规模数据处理到 SFT/RL 后训练与归因评估的闭环。</p>
    <div class="project-card__meta">AUC 0.789 · SFT · DPO · GRPO</div>
  </div>
  <div class="project-card">
    <span class="project-card__eyebrow">PRODUCTION / SANITIZED</span>
    <h3>财务表格智能问答</h3>
